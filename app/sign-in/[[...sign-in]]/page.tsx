...
export default function SignInPage() {
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      {/* Left side - Sign In Form (Neobrutalist) */}
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 bg-gradient-to-r from-emerald-400 to-emerald-600 The class `text-[var(--color-main-foreground)]` can be written as `text-(--color-main-foreground)` border-l-4 border-black dark:border-white" style={{ boxShadow: 'var(--shadow)' }}>
